...
- (NSArray *)items {
    if (!_items) {
        _items = @[
                   @{@"title" : @"EHItemsView Label", @"class" : @"EHDemo1ViewController"},
                   @{@"title" : @"EHItemsView Button", @"class" : @"EHDemo2ViewController"},
                   @{@"title" : @"EHItemsView View", @"class" : @"EHDemo3ViewController"},
                   @{@"title" : @"EHItemsSelectionView Single Selection Non-Cancelable", @"class" : @"EHDemo4ViewController"},
                   ];
    }
