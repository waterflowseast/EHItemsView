...
@interface EHDemo1ViewController () <EHItemsViewDelegate>
...
- (void)configureForNavigationBar {
    self.navigationItem.title = @"EHItemsView Label";
}
...
- (EHItemsView *)itemsView {
    if (!_itemsView) {
        _itemsView = [[EHItemsView alloc] initWithItems:self.labels itemSize:CGSizeMake(kLabelWidth, kLabelHeight) totalWidth:[UIScreen mainScreen].bounds.size.width insets:UIEdgeInsetsMake(15, 15, 15, 15) minimumInteritemSpacing:kMinimumInteritemSpacing minimumLineSpacing:kMinimumLineSpacing];
