...
#import "EHItemsSelectionView.h"
#import "EHLayout.h"

@interface EHItemsSelectionView ()
...
@implementation EHItemsSelectionView
...
- (instancetype)initWithItems:(NSArray<UIView<EHItemViewDelegate> *> *)items itemSize:(CGSize)itemSize totalWidth:(CGFloat)totalWidth insets:(UIEdgeInsets)insets minimumInteritemSpacing:(CGFloat)minimumInteritemSpacing minimumLineSpacing:(CGFloat)minimumLineSpacing {
    self = [super initWithItems:items itemSize:itemSize totalWidth:totalWidth insets:insets minimumInteritemSpacing:minimumInteritemSpacing minimumLineSpacing:minimumLineSpacing];
    if (self) {
...
- (void)resetWithItems:(NSArray<UIView<EHItemViewDelegate> *> *)items itemSize:(CGSize)itemSize totalWidth:(CGFloat)totalWidth insets:(UIEdgeInsets)insets minimumInteritemSpacing:(CGFloat)minimumInteritemSpacing minimumLineSpacing:(CGFloat)minimumLineSpacing {
    ...
    [super resetWithItems:items itemSize:itemSize totalWidth:totalWidth insets:insets minimumInteritemSpacing:minimumInteritemSpacing minimumLineSpacing:minimumLineSpacing];
    _maxSelectionsAllowed = items.count;
    _selectedIndex = -1;
