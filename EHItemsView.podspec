...
EHItemsSelectionView: selection version of EHItemsView, you can single-select or multiple-select
  ...
  s.screenshots     = 'https://github.com/waterflowseast/EHItemsView/screenshots/1.png', 'https://github.com/waterflowseast/EHItemsView/screenshots/2.png', 'https://github.com/waterflowseast/EHItemsView/screenshots/3.png', 'https://github.com/waterflowseast/EHItemsView/screenshots/4.png'
